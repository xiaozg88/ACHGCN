...
plt.title('Train and Validation Accuracy based on the Citeseer dataset', fontsize=14)
plt.legend(fontsize='large')
plt.savefig('Training and Validation Accuracy based on the Citeseer dataset.jpg')  # 保存图像
plt.show()

...
plt.title('Training and Validation Accuracy based on the Cora dataset', fontsize=14)
plt.savefig('Training and Validation Accuracy based on the Cora dataset.jpg')  # 保存图像
plt.show()
...
plt.legend(fontsize='large')
plt.title('Curvature Changes Over Epochs based on the Cora dataset', fontsize=14)
plt.show()
...
plot_tsne(embeddings, labels, title='t-SNE of Node Embeddings based on the Cora dataset')
